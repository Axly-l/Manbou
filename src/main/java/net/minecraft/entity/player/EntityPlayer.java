...
import net.ax.manbou.event.IEvent;
import net.ax.manbou.event.JumpEvent;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void jump()
    {
        JumpEvent event = new JumpEvent(this.getJumpUpwardsMotion(), this.rotationYaw);
        if(this instanceof EntityPlayerSP && EventManager.INSTANCE.call(event)) return;
