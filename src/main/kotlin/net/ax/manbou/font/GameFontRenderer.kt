...
import net.ax.manbou.module.impl.visual.CustomFont
import net.ax.manbou.utils.ColorUtils
import net.ax.manbou.utils.RenderUtils
    ...
    private fun drawText(text: String?, x: Float, y: Float, colorHex: Int, ignoreColor: Boolean): Int {
        ...
        if (text.contains("§")) {
            ...
            parts.forEachIndexed { index, part ->
                ...
                if (index == 0) {
                    currentFont.drawString(part, width, -CustomFont.yOffset.value.toDouble(), hexColor)
                    ...
                    currentFont.drawString(
                        ...
                        width,
                        -CustomFont.yOffset.value.toDouble(),
                        hexColor
                    )
                    ...
                    if (strikeThrough)
                        RenderUtils.drawLine(
                            ...
                            (width + currentFont.getStringWidth(words)) / 2.0 + 1, currentFont.height / 3.0 + -CustomFont.yOffset.value,
                            FONT_HEIGHT / 16F
                        )
                    ...
                    if (underline)
                        RenderUtils.drawLine(
                            ...
                            (width + currentFont.getStringWidth(words)) / 2.0 + 1, currentFont.height / 2.0 + -CustomFont.yOffset.value,
                            FONT_HEIGHT / 16F
                        )
        ...
        } else defaultFont.drawString(text, 0.0, 0.0, hexColor)
